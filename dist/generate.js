...
const getDataFromSource = (source) => {
    return new Promise((resolve, reject) => {
...
const generateBadgeAndSave = (message, format, outputPath) => {
...
export const generate = async () => {
    ...
    if (!config) {
        ...
        for (const badge of badges) {
            const { source, path, message, filename = badge.label, ...badgeFormat } = badge;
